...
from langchain_neo4j.chains import Neo4jGraphCypherQAChain
...
NEO4J_PASSWORD = "REDACTED"  # Your password
...
def setup_graphrag():
    ...
    try:
        # First connect with Neo4jGraph to extract schema information
        graph = Neo4jGraph(
            url=NEO4J_URI,
        ...
        # Create Neo4jGraphStore for the QA chain
        ...
        # Create the Neo4j-specific QA chain
        chain = Neo4jGraphCypherQAChain.from_llm(
            llm=llm,
        ...
        # Fallback to the simpler approach using direct Cypher generation
